...
public class AdminController {
	...
	public String afficherEtudiant(Model model, @RequestParam(name = "username", defaultValue = "") String username,
	...
	public String afficherProfesseur(Model model, @RequestParam(name = "username", defaultValue = "") String username,
			HttpServletRequest request) {
	...
	public String supprimerProfesseur(Model model, @RequestParam(name = "id", defaultValue = "") Long id,
			HttpServletRequest request) {
	...
	public String supprimerEtudiant(Model model, @RequestParam(name = "id", defaultValue = "") Long id,
			HttpServletRequest request) {
